...
const STEPS = [
  { num:"01", title:"Download Form", desc:"Collect the admission form from the school office or download it from this page.", icon:"📄" },
  { num:"02", title:"Fill & Submit",  desc:"Complete the form and submit it with the required documents to the admin office.", icon:"✍️" },
  { num:"03", title:"Assessment Day", desc:"Your child attends a brief readiness assessment conducted by our academic team.", icon:"📝" },
  { num:"04", title:"Offer Letter",   desc:"Successful applicants receive an offer letter within 3–5 working days.", icon:"📬" },
  { num:"05", title:"Pay Fees",       desc:"Accept the offer and make payment of the acceptance fee to secure the spot.", icon:"💳" },
  { num:"06", title:"Resumption",     desc:"Your child joins us on resumption day — welcome to the Delightsome family!", icon:"🎒" },
];
    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing:border-box;margin:0;padding:0; }
        ...
        .ad-prog-deco { position:absolute;bottom:-16px;right:-10px;font-size:5rem;opacity:.12;pointer-events:none; }
        ...
        .ad-step-icon { font-size:1.6rem;margin-bottom:.4rem;display:block; }
        ...
        .ad-req-check { width:28px;height:28px;border-radius:50%;background:#E1F5EE;display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0; }
        ...
        .ad-success-emoji { font-size:2.5rem;display:block;margin-bottom:.75rem; }
        ...
        .ad-info-icon { font-size:1.1rem;flex-shrink:0;margin-top:1px; }
        ...
        .ad-faq-arrow { font-size:18px;transition:transform .3s;flex-shrink:0; }
      ...
      <main>
              ...
              {[{ name:"Crèche", age:"Ages 1–3", desc:"Warm, nurturing care and early stimulation for our youngest learners.", color:"#FAC77533", border:"#FAC775", icon:"👶" },
                ...
                <Reveal key={p.name} delay={i*80}>
                  <div className="ad-prog-card" style={{ background: p.color, border:`2px solid ${p.border}` }}>
                    ...
                    <span className="ad-prog-deco">{p.icon}</span>
                  </div>
                </Reveal>
              ))}
            </div>
              ...
              {STEPS.map((s,i)=>(
                <Reveal key={s.num} delay={i*60}>
                  <div className="ad-step">
                    ...
                    <div>
                      <span className="ad-step-icon">{s.icon}</span>
            ...
            <div className="ad-split">
              ...
              <Reveal>
                <div className="ad-form-card">
                  ...
                  <p className="ad-form-sub">Fill in the details below and we\'ll be in touch within 2 working days.</p>
                  {status === "sent" ? (
                    <div className="ad-success">
                      <span className="ad-success-emoji">🎉</span>
                      <p className="ad-success-title">Application Received!</p>
                      <p className="ad-success-body">Thank you, {form.parentName.split(" ")[0]}! We\'ll contact you at <strong>{form.email}</strong> within 2 working days to guide you through the next steps.</p>
                    </div>
                  ) : (
              ...
              <Reveal key={faq.q} delay={i*50}>
                <div className="ad-faq-item">
                  <button className="ad-faq-q" onClick={()=>setOpenFaq(openFaq===i?null:i)}>
                    <span>{faq.q}</span>
                    <span className={"ad-faq-arrow"+(openFaq===i?" open":"")}>▾</span>
                  </button>
        ...
        <section className="ad-cta">
          <Reveal>
            ...
            <a href="#apply" className="ad-btn-primary" style={{ fontSize:17, padding:"15px 40px" }}>Apply Now →</a>
          </Reveal>
        </section>
