...
const LEGAL_STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .lg-toc a { display: block; font-size: 13px; font-weight: 700; color: #888780; text-decoration: none; padding: 6px 0; border-bottom: 1px solid #F1EFE8; transition: color 0.2s; }
...
const PRIVACY_SECTIONS = [
  { id: "collection", title: "Information We Collect", num: "01", paragraphs: ["When you contact us, enroll a child, or use our website, we may collect personal information such as your name, email address, phone number, and your child's details (name, age, class level)."], bullets: ["Contact information (name, email, phone)", "Child's name, date of birth, and class level", "Messages and enquiries you send us", "Browser and usage data collected automatically via cookies"] },
  { id: "use", title: "How We Use Your Information", num: "02", paragraphs: ["We use the information we collect solely to operate the school effectively and communicate with families. We do not use your data for unrelated commercial purposes."], bullets: ["Processing admission applications", "Communicating about school events and updates", "Responding to enquiries and messages", "Improving our website and services"] },
  { id: "sharing", title: "Sharing of Information", num: "03", paragraphs: ["We do not sell, trade, or rent your personal information to third parties. We may share information with trusted service providers who assist us in operating the school, subject to confidentiality agreements."], bullets: [] },
  { id: "security", title: "Data Security", num: "04", paragraphs: ["We take reasonable measures to protect your personal information from unauthorised access, use, or disclosure. Our systems are secured and access to student data is restricted to authorised staff only."], bullets: [] },
  { id: "rights", title: "Your Rights", num: "05", paragraphs: ["You have the right to access, correct, or request deletion of your personal information at any time. To exercise these rights, please contact us using the details below."], bullets: ["Access the data we hold about you", "Request correction of inaccurate data", "Request deletion of your data", "Withdraw consent at any time"] },
  { id: "cookies", title: "Cookies", num: "06", paragraphs: ["Our website uses cookies to improve your browsing experience. You may disable cookies through your browser settings. Some features of the site may not function correctly without cookies."], bullets: [] },
  { id: "changes", title: "Changes to This Policy", num: "07", paragraphs: ["We may update this Privacy Policy from time to time. We will notify families of significant changes via the school notice board and our website. Continued use of the website after changes constitutes acceptance."], bullets: [] }
];
