    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ct-info-emoji { font-size: 2.2rem; margin-bottom: 0.9rem; display: block; }
        ...
        .ct-success-emoji { font-size: 2.5rem; display: block; margin-bottom: 0.75rem; }
              ...
              {CONTACT_CARDS.map((c, i) => (
                <Reveal key={c.title} delay={i * 80}>
                  <div className="ct-info-card" style={{ background: c.color }}>
                    <span className="ct-info-emoji">{c.emoji}</span>
                ...
                <div className="ct-form-card">
                  ...
                  {status === "sent" ? (
                    <div className="ct-success">
                      <span className="ct-success-emoji">🎉</span>
                ...
                <Reveal delay={100}>
                  <div className="ct-side-block">
                    ...
                    <div className="ct-map">
                      <span className="ct-map-emoji">🗺️</span>
                  ...
                  <div className="ct-side-block">
                    ...
                    <div className="ct-social-row">
                      {[["📘","Facebook"],["📸","Instagram"],["🐦","Twitter"],["▶️","YouTube"]].map(([e, n]) => (
                        <a key={n} href="#" className="ct-social-btn">{e} {n}</a>
                      ))}
                    </div>
                  </div>
                </Reveal>
                <Reveal delay={260}>
                  <div className="ct-side-block">
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem" }}>
                      {[["🎒","Apply for Admission","/admissions"],["📅","Download Calendar","#"],["📋","View Fee Schedule","#"]].map(([e, l, h]) => (
                        <a key={l as string} href={h as string} style={{ display:"flex", alignItems:"center", gap:10, padding:"10px 14px", borderRadius:12, background:"#F1EFE8", fontSize:14, fontWeight:700, color:"#2C2C2A", textDecoration:"none", transition:"background 0.2s" }}
                          ...
                          <span>{e as string}</span>{l as string}
                        </a>
                      ))}
                    </div>
                  </div>
